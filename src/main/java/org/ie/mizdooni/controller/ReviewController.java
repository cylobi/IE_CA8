...
public class ReviewController {
    ...
    String getAll() {
        try {
            String json = new ObjectMapper().writeValueAsString(ReviewModel.getAllObjects());
            return json;
        }
    ...
    String getDetails(@PathVariable String restname){
        try {
            String json = new ObjectMapper().writeValueAsString(ReviewModel.findByRestaurantName(restname));
            return json;
        }
        catch (JsonProcessingException e){
            e.printStackTrace();
